...
*Formally not. But one idea is to use someone's else T1 as reference, PET will be registered to that and will use the other person's parcellation. The fit will not be as good, but given the low resolution nature of PET it may still work. This solution has NOT beed tested.*  
